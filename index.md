...
If we ever change this policy, we will update the **Last updated** date and post the new version at <https://your-url/privacy>. Material changes will be highlighted in the app's release notes.

### 9. Contact
Questions or concerns? Email **<your-email@example.com>**.
...
### 1. 我们是谁
Subly（"本 App"）由 **郑川川**（"我们"）独立开发与维护，所在地：<国家/地区>。
...
### 8. 政策变更
若本政策有变更，我们会更新顶部的"最后更新"日期，并将新版本发布于 <https://your-url/privacy>。重大变更会在 App 更新说明中明示。
